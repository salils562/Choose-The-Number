...
startButton.addEventListener('click', () => {
    ...
    userChance.innerHTML=`<p>Chance left : <b>${chance}</b>`;
...
choose = (comp) => {
    ...
    choose.addEventListener('click', () => {
        ...
        if(chance===1){
          ...
          gui.innerHTML=`<div class="alert alert-danger" role="alert">
          <h4 class="alert-heading mb-5">OOps !</h4>
          <p>AWW !! You lose the game. Thanks for playing , please share wiht your friends and others to let them enjoy the game too.</p>
          <hr>
          <p class="mb-0">Whenever you need stress relief !<br/>You are Always welcome</p>
          <button class="btn btn-primary mt-3 mb-2" id="playagain">Try !! again</button>
        </div>`;
